...
<body>
  <p><?php
  if (isset($_POST['civility']) && ($_POST['lastname']) && ($_POST['firstname']) && ($_POST['myFile'])) {
    echo 'Bonjour ' . $_POST['civility'] . ' ' . $_POST['lastname'] . ' ' . $_POST['firstname'] . '. Votre fichier est : ' . $_POST['myFile'];
  } else {
    ?>
